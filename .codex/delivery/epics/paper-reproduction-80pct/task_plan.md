...
|---|---|---|---|---|---|
| `work/SEA-Nav-Code` | `test@371f354b425bc5037e5832002e68a02896837250` plus current coordination diff | controller | plan/coordination now; each integrated batch serially | approved spec | active, Tasks1–6 integrated; remote read back at same commit |
...
| `work/SEA-Nav-Code-batch7-v2` | detached `92ab65d23590256f3165d8cad6e64698cf11bfe8`; BASE `399ce2b08eac40865fd6496d19324f73a3e6cc7e` | `/root/review_batch7_callers` | Task 7 retained v2 checkpoint/registry/runner/caller/tests/docs paths only; converter files absent | independent FAIL: transactional load, Adam target compatibility, fixed CBF geometry, payload byte accounting | fix round active; not integrated or published |
