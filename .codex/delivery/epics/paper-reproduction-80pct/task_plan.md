...
| `work/SEA-Nav-Code-diffdrive-core` | detached `bf409c65ac2d6dc43bfacfd8f99c31cfe5537eb9`; BASE `399ce2b08eac40865fd6496d19324f73a3e6cc7e` | `/root/fix_diffdrive_core` | only `packages/sea_nav_core/**` and its existing focused tests/docs; retain two local registration diffs outside the functional commit | independent FAIL in `diffdrive-core-review.md`; accepted user contract and DashGo provenance | fix round registered; no overlap with Task 7, not integrated or published |
