...
| Primary read-only CBF checked-path preparation | fixed source `12e4fff0714f5753e30bf2575e740dc12a32c051` | `/root/cbf_hotpath_review` | only coordination cbf-checked-path-probe.md | prior open CBF P2; Task 6 remains sole source writer | bounded in-memory CPU prototype only; not implementation or acceptance |
