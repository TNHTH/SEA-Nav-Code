...
|---|---|---|---|
| Artifact / version identity | SEA primary/remote `test@b94aede1fe3135e0a80eae1ea69021efee37d9fd`; Task7 fix candidate `3b6e97d0004eac6ff3f04be4e7b56acb693db414`; differential-drive rejected candidate `bf409c65ac2d6dc43bfacfd8f99c31cfe5537eb9`; DashGo primary/remote `test@10023c294f34dc32a97005103bc30e6aa0f09bf5` | 2026-09-08 branch/tag readback and independent reviews | Task7 fix is preserved only by an explicit unreviewed checkpoint tag; it is not integrated into `test` |
| Active evidence instance | Tasks1–6 primary342 tests; Task7 writer candidate and diffdrive writer candidate; DashGo read-only contract/API audit against Isaac Lab v2.0.2 and RSL-RL v3.0.1 | exact worktree OIDs, fixed upstream clones, agent handoffs | writer tests are not independent acceptance; no DashGo adapter source has landed |
...
| Highest validation rung | SEA Tasks1–6 at Rung1 with non-final GateA; DashGo at source/static contract audit | prior fresh CPU suites and fixed-version API source | final frozen Rung2, both simulator stacks, formal metrics, and hardware remain pending/blocked |
| Unpublished/unverified work | Task7 fix `3b6e97d` under independent rereview; differential-drive core fix in progress from `bf409c65`; all planned DashGo adapter code | detached worktrees, checkpoint tag and current audit | do not label either candidate complete until independent review, primary test, committed-tree scan, branch push, and read-back |
