...
|---|---|---|---|
| Artifact / version identity | SEA accepted D0 source checkpoint `83041a34a8efe1f824f0421fe2dc4845930d6900`; reviewed source candidate `2cd810569008fa923bda088f0f0988292e0c809c`; current `test` may add receipt-only descendants; DashGo primary/remote `test@53bd0f0ab0100e295aed1f726c2c3c9f4ffb3b06` | 2026-09-08 source publication readback plus independent source/CPU and artifact reviews | differential-drive D0 is integrated and published; receipt descendants do not change its package tree; no DashGo adapter source has landed |
| Active evidence instance | SEA Tasks1–7 plus differential-drive D0 integrated; fresh package `284 passed`, complete combination `863 passed/2 CUDA skips`, Gate A `5 passed/4 Isaac blockers`; DashGo D1 preflight | exact OIDs, committed review receipts, package installation probes, primary integration runs, remote readback | CPU/static/package evidence only; simulator and hardware are not implied |
