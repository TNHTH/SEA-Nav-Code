...
|---|---|---|---|
| Artifact / version identity | SEA primary/remote `test@371f354b425bc5037e5832002e68a02896837250`; Task7 v2-only rejected candidate `92ab65d23590256f3165d8cad6e64698cf11bfe8`; differential-drive rejected candidate `bf409c65ac2d6dc43bfacfd8f99c31cfe5537eb9`; DashGo primary/remote `test@10023c294f34dc32a97005103bc30e6aa0f09bf5` | 2026-09-08 preflight, SEA fetch/readback and independent reviews | only the two primary `test` OIDs are published; detached candidates require fixes, independent acceptance and serial integration |
...
| Unpublished/unverified work | Task7 `92ab65d`; differential-drive core `bf409c65`; all planned DashGo adapter code | detached worktrees and current audit | do not label either candidate complete until independent review, primary test, committed-tree scan, push, and read-back |
