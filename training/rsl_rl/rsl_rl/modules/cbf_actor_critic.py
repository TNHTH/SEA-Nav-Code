...
class DifferentiableSafeActorCritic(nn.Module):
    ...
    def update_distribution(self, observations):
        ...
        std = torch.nan_to_num(self.std, nan=self.min_std, posinf=10.0, neginf=self.min_std)
        std = std.clamp(min=self.min_std, max=10.0)
    ...
    def act_inference(self, observations, **kwargs):
        ...
        u_s = self.action_mean_for(observations, **kwargs)
        return u_s
