...
def test_standalone_namespace_does_not_import_robotics_or_vendored_trainer():
    ...
    code = "import sys; import sea_nav_core; assert not any(n.split('.')[0] in {'rsl_rl','isaacgym','isaaclab','rclpy','legged_gym'} for n in sys.modules); assert sea_nav_core.__version__ == '0.3.0'"
